...
本目錄收錄的字型檔皆遵循 **SIL Open Font License 1.1 (OFL-1.1)**。
OFL-1.1 全文：https://scripts.sil.org/cms/scripts/page.php?item_id=OFL_web

## 字型清單

### 霞鶩臻楷 (LxgwZhenKai) — `lxgw-zhenkai.woff2`
- 作者：lxgw
- 原始下載：https://github.com/lxgw/LxgwZhenKai
- 授權：OFL-1.1

### 悠哉字體 (Yozai-Font) — `yozai.woff2`
- 作者：lxgw
- 原始下載：https://github.com/lxgw/Yozai-Font
- 授權：OFL-1.1

### 小賴字體 (Xiaolai / kose-font) — `xiaolai.woff2`
- 作者：lxgw
- 原始下載：https://github.com/lxgw/kose-font
- 授權：OFL-1.1

### 霞鶩漫黑 (LxgwMarkerGothic) — `marker.woff2`
- 作者：lxgw
- 原始下載：https://github.com/lxgw/LxgwMarkerGothic
- 授權：OFL-1.1

### 辰宇落雁體 (ChenYuluoyan) — `chenyuluoyan.woff2`
- 作者：Chenyu-otf
